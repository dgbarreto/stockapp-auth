...
import com.danilobarreto.stockapp.designsystem.components.StockAppCodeInput
...
fun ResetCodeScreen(
    ...
    Column(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            Text("Digite o código", style = StockAppTypography.titleLarge, color = StockAppColors.textPrimary)
            Text(
        ...
        StockAppPrimaryButton(
            ...
            onClick = { viewModel.validateCode(code, onSuccess = onCodeValidated) },
        ...
        Text(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .clickable { viewModel.resendCode() },
        )
    }
}